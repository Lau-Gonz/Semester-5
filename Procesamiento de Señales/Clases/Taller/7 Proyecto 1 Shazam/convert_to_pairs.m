...
del_t = 35; % bound on time difference (in pixels) (35)
del_f = 30; % bound on frequency difference (in pixels) (30)
fanout = 3; % Maximum number of pairs per peak. (3)
...
% like making sure that I don't index outside of the matrix.
for i = 1:peakCount
    links = 0;
